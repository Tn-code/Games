    ...
    <div className="flex-1 p-8 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {quizzes.map(quiz => (
            <div key={quiz.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all overflow-hidden">
              {quiz.imageUrl && (
                <div className="h-40 overflow-hidden">
                  <img 
                    ...
                    onError={(e) => {
                      e.target.src = 'https://via.placeholder.com/400x200/cccccc/666666?text=Quiz';
                    }}
                  />
                </div>
              )}
